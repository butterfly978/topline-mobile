<template>
  <div class="article-wrap">
    <van-nav-bar title="黑马头条" left-text="返回" left-arrow @click-left="$router.back()" />
    ...
    <CommentList :source="$route.params.articleId.toString()" @is-replylist-show="handleIsReplyListShow" />
    <!-- 回复列表组件 -->
    <ReplyList v-model="isReplyListShow" :comment-id="commentId" />
    <!-- /回复列表组件 -->
    <WriteComment />
  </div>
</template>
