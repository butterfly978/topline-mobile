<template>
  <div class="more-action">
    <van-button icon="star-o" round :loading="isLikeLoading" :type="isLike ? 'danger' : 'defult'" @click="handleLike">{{ isLike ? '取消' : '' }}点赞</van-button>
    <van-button icon="delete" round :loading="isDislikeLoading" :type="isDislike ? 'danger' : 'default'" @click="handleDislike">{{ isDislike ? '取消' : '' }}不喜欢</van-button>
  </div>
</template>
